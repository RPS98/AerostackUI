...
class LocalCoordinates {
    ...
    getLatLng(xLocal, yLocal, zone = this.originZone, band = this.originBand) {
        let x = parseFloat(xLocal) + this.originEasting;
        let y = parseFloat(yLocal) + this.originNorthing;
